...
// UpdateCustomImageResponseData struct for UpdateCustomImageResponseData
...
func NewUpdateCustomImageResponseData(tenantId string, customerId string, imageId string) *UpdateCustomImageResponseData {
	this := UpdateCustomImageResponseData{}
...
func (o UpdateCustomImageResponseData) MarshalJSON() ([]byte, error) {
...
type NullableUpdateCustomImageResponseData struct {
	value *UpdateCustomImageResponseData
	isSet bool
}

func (v NullableUpdateCustomImageResponseData) Get() *UpdateCustomImageResponseData {
	return v.value
}

func (v *NullableUpdateCustomImageResponseData) Set(val *UpdateCustomImageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCustomImageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCustomImageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCustomImageResponseData(val *UpdateCustomImageResponseData) *NullableUpdateCustomImageResponseData {
	return &NullableUpdateCustomImageResponseData{value: val, isSet: true}
}

func (v NullableUpdateCustomImageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCustomImageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
