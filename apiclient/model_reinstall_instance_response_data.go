...
// ReinstallInstanceResponseData struct for ReinstallInstanceResponseData
...
func NewReinstallInstanceResponseData(tenantId string, customerId string, instanceId int64, createdDate time.Time) *ReinstallInstanceResponseData {
	this := ReinstallInstanceResponseData{}
...
func (o ReinstallInstanceResponseData) MarshalJSON() ([]byte, error) {
...
type NullableReinstallInstanceResponseData struct {
	value *ReinstallInstanceResponseData
	isSet bool
}

func (v NullableReinstallInstanceResponseData) Get() *ReinstallInstanceResponseData {
	return v.value
}

func (v *NullableReinstallInstanceResponseData) Set(val *ReinstallInstanceResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReinstallInstanceResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReinstallInstanceResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReinstallInstanceResponseData(val *ReinstallInstanceResponseData) *NullableReinstallInstanceResponseData {
	return &NullableReinstallInstanceResponseData{value: val, isSet: true}
}

func (v NullableReinstallInstanceResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReinstallInstanceResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
