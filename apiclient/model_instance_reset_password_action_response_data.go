...
// InstanceResetPasswordActionResponseData struct for InstanceResetPasswordActionResponseData
...
func NewInstanceResetPasswordActionResponseData(tenantId string, customerId string, instanceId int64, action string) *InstanceResetPasswordActionResponseData {
	this := InstanceResetPasswordActionResponseData{}
...
func (o InstanceResetPasswordActionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInstanceResetPasswordActionResponseData struct {
	value *InstanceResetPasswordActionResponseData
	isSet bool
}

func (v NullableInstanceResetPasswordActionResponseData) Get() *InstanceResetPasswordActionResponseData {
	return v.value
}

func (v *NullableInstanceResetPasswordActionResponseData) Set(val *InstanceResetPasswordActionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceResetPasswordActionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceResetPasswordActionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceResetPasswordActionResponseData(val *InstanceResetPasswordActionResponseData) *NullableInstanceResetPasswordActionResponseData {
	return &NullableInstanceResetPasswordActionResponseData{value: val, isSet: true}
}

func (v NullableInstanceResetPasswordActionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceResetPasswordActionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
