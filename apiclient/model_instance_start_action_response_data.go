...
// InstanceStartActionResponseData struct for InstanceStartActionResponseData
...
func NewInstanceStartActionResponseData(tenantId string, customerId string, instanceId int64, action string) *InstanceStartActionResponseData {
	this := InstanceStartActionResponseData{}
...
func (o InstanceStartActionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInstanceStartActionResponseData struct {
	value *InstanceStartActionResponseData
	isSet bool
}

func (v NullableInstanceStartActionResponseData) Get() *InstanceStartActionResponseData {
	return v.value
}

func (v *NullableInstanceStartActionResponseData) Set(val *InstanceStartActionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceStartActionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceStartActionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceStartActionResponseData(val *InstanceStartActionResponseData) *NullableInstanceStartActionResponseData {
	return &NullableInstanceStartActionResponseData{value: val, isSet: true}
}

func (v NullableInstanceStartActionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceStartActionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
