...
// CreateCustomImageResponseData struct for CreateCustomImageResponseData
...
func NewCreateCustomImageResponseData(tenantId string, customerId string, imageId string) *CreateCustomImageResponseData {
	this := CreateCustomImageResponseData{}
...
func (o CreateCustomImageResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateCustomImageResponseData struct {
	value *CreateCustomImageResponseData
	isSet bool
}

func (v NullableCreateCustomImageResponseData) Get() *CreateCustomImageResponseData {
	return v.value
}

func (v *NullableCreateCustomImageResponseData) Set(val *CreateCustomImageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCustomImageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCustomImageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCustomImageResponseData(val *CreateCustomImageResponseData) *NullableCreateCustomImageResponseData {
	return &NullableCreateCustomImageResponseData{value: val, isSet: true}
}

func (v NullableCreateCustomImageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCustomImageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
