...
// PatchInstanceResponseData struct for PatchInstanceResponseData
...
func NewPatchInstanceResponseData(tenantId string, customerId string, instanceId int64, createdDate time.Time) *PatchInstanceResponseData {
	this := PatchInstanceResponseData{}
...
func (o PatchInstanceResponseData) MarshalJSON() ([]byte, error) {
...
type NullablePatchInstanceResponseData struct {
	value *PatchInstanceResponseData
	isSet bool
}

func (v NullablePatchInstanceResponseData) Get() *PatchInstanceResponseData {
	return v.value
}

func (v *NullablePatchInstanceResponseData) Set(val *PatchInstanceResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchInstanceResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchInstanceResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchInstanceResponseData(val *PatchInstanceResponseData) *NullablePatchInstanceResponseData {
	return &NullablePatchInstanceResponseData{value: val, isSet: true}
}

func (v NullablePatchInstanceResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchInstanceResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
