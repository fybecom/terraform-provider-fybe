...
// CancelInstanceResponseData struct for CancelInstanceResponseData
...
func NewCancelInstanceResponseData(tenantId string, customerId string, instanceId int64, cancelDate string) *CancelInstanceResponseData {
	this := CancelInstanceResponseData{}
...
func (o CancelInstanceResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCancelInstanceResponseData struct {
	value *CancelInstanceResponseData
	isSet bool
}

func (v NullableCancelInstanceResponseData) Get() *CancelInstanceResponseData {
	return v.value
}

func (v *NullableCancelInstanceResponseData) Set(val *CancelInstanceResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelInstanceResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelInstanceResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelInstanceResponseData(val *CancelInstanceResponseData) *NullableCancelInstanceResponseData {
	return &NullableCancelInstanceResponseData{value: val, isSet: true}
}

func (v NullableCancelInstanceResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelInstanceResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
