...
// InstanceRestartActionResponseData struct for InstanceRestartActionResponseData
...
func NewInstanceRestartActionResponseData(tenantId string, customerId string, instanceId int64, action string) *InstanceRestartActionResponseData {
	this := InstanceRestartActionResponseData{}
...
func (o InstanceRestartActionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInstanceRestartActionResponseData struct {
	value *InstanceRestartActionResponseData
	isSet bool
}

func (v NullableInstanceRestartActionResponseData) Get() *InstanceRestartActionResponseData {
	return v.value
}

func (v *NullableInstanceRestartActionResponseData) Set(val *InstanceRestartActionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceRestartActionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceRestartActionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceRestartActionResponseData(val *InstanceRestartActionResponseData) *NullableInstanceRestartActionResponseData {
	return &NullableInstanceRestartActionResponseData{value: val, isSet: true}
}

func (v NullableInstanceRestartActionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceRestartActionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
