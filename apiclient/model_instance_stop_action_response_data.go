...
// InstanceStopActionResponseData struct for InstanceStopActionResponseData
...
func NewInstanceStopActionResponseData(tenantId string, customerId string, instanceId int64, action string) *InstanceStopActionResponseData {
	this := InstanceStopActionResponseData{}
...
func (o InstanceStopActionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInstanceStopActionResponseData struct {
	value *InstanceStopActionResponseData
	isSet bool
}

func (v NullableInstanceStopActionResponseData) Get() *InstanceStopActionResponseData {
	return v.value
}

func (v *NullableInstanceStopActionResponseData) Set(val *InstanceStopActionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceStopActionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceStopActionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceStopActionResponseData(val *InstanceStopActionResponseData) *NullableInstanceStopActionResponseData {
	return &NullableInstanceStopActionResponseData{value: val, isSet: true}
}

func (v NullableInstanceStopActionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceStopActionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
