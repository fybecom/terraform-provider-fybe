...
// InstanceShutdownActionResponseData struct for InstanceShutdownActionResponseData
...
func NewInstanceShutdownActionResponseData(tenantId string, customerId string, instanceId int64, action string) *InstanceShutdownActionResponseData {
	this := InstanceShutdownActionResponseData{}
...
func (o InstanceShutdownActionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableInstanceShutdownActionResponseData struct {
	value *InstanceShutdownActionResponseData
	isSet bool
}

func (v NullableInstanceShutdownActionResponseData) Get() *InstanceShutdownActionResponseData {
	return v.value
}

func (v *NullableInstanceShutdownActionResponseData) Set(val *InstanceShutdownActionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceShutdownActionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceShutdownActionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceShutdownActionResponseData(val *InstanceShutdownActionResponseData) *NullableInstanceShutdownActionResponseData {
	return &NullableInstanceShutdownActionResponseData{value: val, isSet: true}
}

func (v NullableInstanceShutdownActionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceShutdownActionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
